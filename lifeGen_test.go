...
func TestLifeGenCountCells(t *testing.T) {
	...
	lg.AddCellsAtOffset(0, 0, 0, []int32{2, 2})
	testCountNear(t, lg, 2, 2, 0)
	lg.AddCellsAtOffset(0, 0, 0, []int32{1, 1})
	testCountNear(t, lg, 2, 2, 1)
	lg.AddCellsAtOffset(0, 0, 0, []int32{1, 2})
	testCountNear(t, lg, 2, 2, 2)
	lg.AddCellsAtOffset(0, 0, 0, []int32{1, 3})
	testCountNear(t, lg, 2, 2, 3)
	lg.AddCellsAtOffset(0, 0, 0, []int32{2, 1})
	testCountNear(t, lg, 2, 2, 4)
	lg.AddCellsAtOffset(0, 0, 0, []int32{2, 3})
	testCountNear(t, lg, 2, 2, 5)
	lg.AddCellsAtOffset(0, 0, 0, []int32{3, 1})
	testCountNear(t, lg, 2, 2, 6)
	lg.AddCellsAtOffset(0, 0, 0, []int32{3, 2})
	testCountNear(t, lg, 2, 2, 7)
	lg.AddCellsAtOffset(0, 0, 0, []int32{3, 3})
...
func TestLifeGenAddCells(t *testing.T) {
	lg := NewLifeGen(nil, RUN_FOR_EVER)
	lg.AddCellsAtOffset(0, 0, 0, []int32{1, 1, 2, 2})
	testGen(t, lg, "Add Cells:", "1,1 2,2")
	lg.AddCellsAtOffset(0, 0, 0, []int32{0, 0, 1, 1, 2, 2})
...
func testGet(t *testing.T, lg *LifeGen, x, y int32, exp int) {
...
func testCountNear(t *testing.T, lg *LifeGen, x, y int32, exp int) {
