...
func (lc *LifeCell) XYF() (float32, float32) {
	return float32(lc.x), float32(lc.y)
}
...
func (lg *LifeGen) CellsInBounds(X1, Y1, X2, Y2 int32, found func(*LifeCell)) {
	if found == nil {
		return
	}
	cell := lg.GetRootCell()
...
func (lg *LifeGen) countNearFast(x, y int32) int {
...
func (lg *LifeGen) countNear(x, y int32, deadCells *LifeDeadCells) int {
...
func (lg *LifeGen) GetBounds() (int32, int32, int32, int32) {
...
func (lg *LifeGen) AddCell(x, y int32, mode int) {
...
func (lg *LifeGen) AddCellsAtOffset(x, y int32, mode int, c []int32) int {
	n := 0
...
func (lg *LifeGen) ListCellsWithMode(mask int) []int32 {
	resp := make([]int32, 0)
	lg.VisitAllCells(func(lc *LifeCell) bool {
...
func (lg *LifeGen) RemoveCell(x, y int32) {
	c := lg.generations[lg.currentGenId]
	if c == nil {
		return
	}
